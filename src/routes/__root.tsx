...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Caminhos de aprendizado organizados por tema para você estudar programação com o freeCodeCamp em português, sem se perder no meio do caminho." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "freeCodeCamp Trilhas" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "freeCodeCamp Trilhas — Roteiros de Estudo Curados" },
